package com.kiranbahalaskar.staggredrecyclerview
...
import com.kiranbahalaskar.staggredrecyclerview.Adapter.AvengersAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvAvengers.layoutManager = StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL)
